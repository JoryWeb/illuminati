...
class ReportInvoiceExport(models.AbstractModel):
    _name = 'report.poi_sale_export.invoice_copy_export_template'

    @api.multi
    def render_html(self, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('poi_sale_export.invoice_copy_export_template')
        ...
        if inv_id and inv_id.tipo_fac == '13':
            return report_obj.render('poi_sale_export.invoice_copy_export_template', docargs)
