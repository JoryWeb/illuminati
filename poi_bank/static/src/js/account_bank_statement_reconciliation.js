openerp.poi_bank = function (instance) {
    ...
    instance.web.account.poiBankStatementReconciliation = instance.web.Widget.extend({
                ...
                return self.model_bank_statement_line
                    ...
                    .then(function (data) {
                        ...
                        if (data.unreconciled.length > 0){
                            console.log('HAY NO RECONCILIADOS');
                            var unreconciled_promises = [];
                            while ((unreconciled_line = data.unreconciled.shift()) !== undefined){
                                unreconciled_promises.push(self.displayUnreconciledBankStatementLines(unreconciled_line.st_line_id,false,unreconciled_line.st_line));
                            }
                            $.when.apply($, unreconciled_promises).then(function(){
                                console.log('QUE PACHA AQUI?');
                            });
                        }
                    });
                // Display the reconciliations
                return self.model_bank_statement_line
                    .call("get_data_for_bank_reconciliations", [reconciliations_to_show], {context:self.session.user_context})
                    .then(function (data) {
                        var child_promises = [];
                        while ((datum = data.shift()) !== undefined){
                            ...
                            self.displayUnreconciledBankStatementLines(datum.st_line_id,false,datum.st_line);
                        }
        ...
        close_all_paired_statements: function() {
            var self = this;
            self.persistReconciliations(_.filter(self.getChildren(), function(o) { return self.monetaryIsZero(o.get("balance")); }));
        },
        persistReconciliations: function(reconciliations) {
            ...
            deferred_rpc = self.model_bank_statement_line.call("process_bank_reconciliations", [data]);
        ...
        //ESTA FUNCION MUESTRA LAS CONCILIACIONES, EN BASE A ESTO DEBO TRABAJAR
        displayReconciliations: function(number) {
            ...
            return self.model_bank_statement_line
                .call("get_data_for_bank_reconciliations", [reconciliations_to_show, excluded_move_lines_ids])
                .then(function (data) {
                    var child_promises = [];
                    var datum;
                    while ((datum = data.shift()) !== undefined) {
                        ...
                        console.log('POIESIS');
                        var widget = new instance.web.account.poiBankStatementReconciliationLine(self, context);
                        child_promises.push(widget.appendTo(self.$(".reconciliation_lines_container")));

                        var statement_widget = new instance.web.account.poiBankUnreconciledStatementLine(self, context);
                        console.log('STATEMENT WIDGET', statement_widget);

                        child_promises.push(widget.appendTo(self.$(".unreconciled_bank_statements > table > tbody")))
                    }
        ...
        displayDoneMessage: function() {
            ...
            self.$(".protip").hide();
            self.updateShowMoreButton();
            self.$(".oe_form_sheet").append(QWeb.render("poi_bank_statement_reconciliation_done_message", {
                title: title,
    ...
    instance.web.account.poiBankStatementReconciliationLine = instance.web.Widget.extend({
        ...
        init: function(parent, context) {
            console.log('ReconcileLine init');
            this._super(parent);
        ...
        loadData: function() {
            console.log('ReconcileLine loadData');
            var self = this;
            ...
            // Load statement line
            return self.model_bank_statement_line
                .call("get_data_for_bank_reconciliations", [[self.st_line_id], excluded_move_lines_ids, self.do_load_reconciliation_proposition])
                .then(function (data) {
        ...
        render: function() {
            console.log('ReconcileLine render');
            var self = this;
            var presets_array = [];
            for (var id in self.presets)
                if (self.presets.hasOwnProperty(id))
                    presets_array.push(self.presets[id]);
            self.$el.prepend(QWeb.render("poi_bank_statement_reconciliation_line", {
                line: self.st_line,
            ...
            if (self.st_line.no_match) {
                console.log('ESTE ST LINE', self.st_line);
        ...
        restart: function(mode) {
            console.log('ReconcileLine restart', mode);
            var self = this;
        ...
        createFormWidgets: function() {
            console.log('ReconcileLine createFormWidgets');
            var self = this;
            ...
            for (var i=0; i<create_form_fields_arr.length; i++) {
                ...
                // append to DOM
                var $field_container = $(QWeb.render("poi_form_create_field", {id: field_data.id, label: field_data.label}));
        ...
        decorateStatementLine: function(line){
            console.log('ReconcileLine decorateStatementLine', line);
            line.q_popover = QWeb.render("poi_bank_statement_reconciliation_line_details", {line: line});
        },
    
        // adds fields, prefixed with q_, to the move line for qweb rendering
        decorateMoveLine: function(line, currency_id) {
            console.log('ReconcileLine decorateMoveLine', line, currency_id);
            ...
            line.q_popover = QWeb.render("poi_bank_statement_reconciliation_move_line_details", {line: line});
        ...
        bindPopoverTo: function(el) {
            console.log('ReconcileLine bindPopoverTo');
            var self = this;
        ...
        islineCreatedBeingEditedValid: function() {
            console.log('ReconcileLine islineCreatedBeingEditedValid');
        ...
        getCreatedLines: function() {
            console.log('ReconcileLine getCreatedLines');
            var self = this;
        ...
        moveLineClickHandler: function(e) {
            console.log('ReconcileLine moveLineClickHandler');
            var self = this;
        ...
        selectMoveLine: function(mv_line) {
            console.log('ReconcileLine selectMoveLine', mv_line);
            var self = this;
        ...
        deselectMoveLine: function(mv_line) {
            console.log('ReconcileLine deselectMoveLine');
            var self = this;
            var line_id = mv_line.dataset.lineid;
        ...
        pagerControlLeftHandler: function() {
            console.log('ReconcileLine pagerControlLeftHandler');
            var self = this;
        ...
        pagerControlRightHandler: function() {
            console.log('ReconcileLine pagerControlRightHandler');
            var self = this;
        ...
        filterHandler: function() {
            console.log('ReconcileLine filterHandler');
            var self = this;
        ...
        initializeCreateForm: function() {
            console.log('ReconcileLine initializeCreateForm');
            var self = this;
        ...
        addLineBeingEdited: function() {
            console.log('ReconcileLine addLineBeingEdited');
            var self = this;
        ...
        removeLine: function($line) {
            console.log('ReconcileLine removeLine');
            var self = this;
        ...
        presetClickHandler: function(e) {
            console.log('ReconcileLine presetClickHandler');
            var self = this;
            self.initializeCreateForm();
        ...
        initialLineClickHandler: function() {
            console.log('ReconcileLine initialLineClickHandler');
            var self = this;
        ...
        lineOpenBalanceClickHandler: function() {
            console.log('ReconcileLine lineOpenBalanceClickHandler');
            var self = this;
        ...
        changePartnerClickHandler: function() {
            console.log('ReconcileLine changePartnerClickHandler');
            var self = this;
        ...
        updateAccountingViewMatchedLines: function() {
            console.log('ReconcileLine updateAccountingViewMatchedLines');
            var self = this;
            ...
            _(self.get("mv_lines_selected")).each(function(line){
                var $line = $(QWeb.render("poi_bank_statement_reconciliation_move_line", {line: line, selected: true}));
        ...
        updateAccountingViewCreatedLines: function() {
            console.log('ReconcileLine updateAccountingViewCreatedLines');
            var self = this;
            ...
            _(self.getCreatedLines()).each(function(line){
                var $line = $(QWeb.render("poi_bank_statement_reconciliation_created_line", {line: line}));
        ...
        updateMatchView: function() {
            console.log('ReconcileLine updateMatchView');
            var self = this;
            ...
            _( _.filter(self.mv_lines_deselected, function(o){
                ...
                var $line = $(QWeb.render("poi_bank_statement_reconciliation_move_line", {line: line, selected: false}));
                self.bindPopoverTo($line.find(".line_info_button"));
                table.append($line);
            ...
            if (nothing_displayed && this.filter !== "")
                table.append(QWeb.render("poi_filter_no_match", {filter_str: self.filter}));
        },
    
        updatePagerControls: function() {
            console.log('ReconcileLine updatePagerControls');
            var self = this;
        ...
        balanceChanged: function() {
            console.log('ReconcileLine balanceChanged');
            var self = this;
            ...
            function createOpenBalance(name) {
                ...
                var $line = $(QWeb.render("poi_bank_statement_reconciliation_line_open_balance", {
        ...
        modeChanged: function(o, val) {
            console.log('ReconcileLine modeChanged', val);
            var self = this;
        ...
        mvLinesChanged: function() {
            console.log('ReconcileLine mvLinesChanged');
            var self = this;
            ...
            if (self.get("mv_lines").length + self.mv_lines_deselected.length === 0 && !self.can_fetch_more_move_lines && self.filter === "") {
                console.log('ESTE LE PONE EL NOMATCH 1', self.get("mv_lines").length + self.mv_lines_deselected.length, self.can_fetch_more_move_lines, self.filter);
                console.log('ESTE ST LINE 2', self.st_line);
                self.$el.addClass("no_match");
                if (self.get("mode") === "match") {
                    self.set("mode", "inactive");
                }
        ...
        mvLinesSelectedChanged: function(elt, val) {
            console.log('ReconcileLine mvLinesSelectedChanged');
            var self = this;
        ...
        formCreateInputChanged: function(elt, val) {
            console.log('ReconcileLine formCreateInputChanged');
            var self = this;
        ...
        createdLinesChanged: function() {
            console.log('ReconcileLine createdLinesChanged');
            var self = this;
        ...
        doPartialReconcileButtonClickHandler: function(e) {
            console.log('ReconcileLine doPartialReconcileButtonClickHandler');
            var self = this;
        ...
        partialReconcileLine: function(line) {
            console.log('ReconcileLine partialReconcileLine', line);
            var self = this;
            var balance = self.get("balance");
        ...
        undoPartialReconcileButtonClickHandler: function(e) {
            console.log('ReconcileLine undoPartialReconcileBluttonClickHandler');
            var self = this;
        ...
        unpartialReconcileLine: function(line) {
            console.log('ReconcileLine unpartialReconcileLine', line);
            var self = this;
        ...
        updateBalance: function() {
            console.log('ReconcileLine updateBalance');
            var self = this;
        ...
        updateMatches: function() {
            console.log('ReconcileLine updateMatches');
            var self = this;
            ...
            if (limit > 0) {
                return self.model_bank_statement_line
                    .call("get_move_lines_for_bank_reconciliation_by_statement_line_id", [self.st_line.id, excluded_ids, self.filter, offset, limit], {context:self.session.user_context})
                    .then(function (lines) {
                        console.log('DEBUG get_move_lines_for_bank_reconciliation_by_statement_line_id', lines);
        ...
        changePartner: function(partner_id) {
            console.log('ReconcileLine changePartner');
            var self = this;
            self.is_consistent = false;
            return self.model_bank_statement_line
                // Update model
        ...
        // Returns an object that can be passed to process_bank_reconciliation()
        prepareSelectedMoveLineForPersisting: function(line) {
            console.log('ReconcileLine prepareSelectedMoveLineForPersisting');
            return {
                name: line.name,
                debit: line.debit,
                credit: line.credit,
        ...
        prepareCreatedMoveLineForPersisting: function(line) {
            console.log('ReconcileLine prepareCreatedMoveLineForPersisting');
            var dict = {};
        ...
        prepareOpenBalanceForPersisting: function() {
            console.log('ReconcileLine prepareOpenBalanceForPersisting');
        ...
        makeMoveLineDicts: function() {
            console.log('ReconcileLine makeMoveLineDicts');
            var self = this;
            var mv_line_dicts = [];
        ...
        persistAndDestroy: function(speed) {
            console.log('ReconcileLine persistAndDestroy');
            var self = this;
            ...
            return self.model_bank_statement_line
                .call("process_bank_reconciliation", [self.st_line_id, self.makeMoveLineDicts()])
                .done(function () {
                    self.getParent().unexcludeMoveLines(self, self.partner_id, self.get("mv_lines_selected"));
                    $.each(self.$(".bootstrap_popover"), function(){ $(this).popover('destroy') });
