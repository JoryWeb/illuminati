/*---------------------------------------------------------
 * OpenERP poi_web_chart
 *---------------------------------------------------------*/

/* jshint undef: false  */

openerp.poi_web_chart = function (instance) {
'use strict';

var _lt = instance.web._lt;
var _t = instance.web._t;

instance.web.views.add('chart', 'instance.poi_web_chart.ChartView');

instance.poi_web_chart.ChartView = instance.web.View.extend({
    ...
    init: function(parent, dataset, view_id, options) {
        ...
        this.col_search_field = {
            get_context: function() { return { col_group_by: self.chart_widget.get_col_groupbys(),
                measures: self.chart_widget.get_current_measures()};},
            get_domain: function () {},
    ...
    do_search: function (domain, context, group_by) {
        ...
        if (!this.chart_widget) {
            ...
            this.chart_widget = new openerp.poi_web_chart.Chart(this, this.model, domain, this.widget_config);
            ...
            this.ViewManager.on('switch_mode', this, function (e) {
                if (e === 'chart') {
                    ...
                    this.chart_widget.set(domain, group_bys.group_by, group_bys.col_group_by, group_bys.measures);
                }
            });
            return;
        }

        this.chart_widget.set(domain, group_by, col_group_by, measures);
    },
