...
class report_kardex_wizard(models.TransientModel):
    _name = "all.sales.analysis.wizard"
    ...
    product_ids = fields.One2many('all.sales.analysis.wizard.lines','wizard_id', String='Products')
    ...
    def view_report(self):
        ...
        self.env['m.report.view'].check_and_refresh_materialized_view("product_pos_orders_list")
        ...
        self.env['m.report.view'].check_and_refresh_materialized_view("product_analysis_sales")

        data_obj = self.pool.get('ir.model.data')
        model_data_id = self.env['ir.model.data']._get_id('poi_logistic_analysis_all_sales', 'view_product_analysis_sales_graph')
        ...
        return {
            ...
            'view_type': 'form',
            'view_mode': 'chart',
            'res_model': 'product.analysis.sales',
            'view_id': res_id,
            'context': {},
...
class report_kardex_wizard_lines(models.TransientModel):
    ...
    """
    _name = "all.sales.analysis.wizard.lines"
    _description = "POS order analysis Wizard Lines"


    wizard_id = fields.Many2one('all.sales.analysis.wizard', 'Wizard')
    product_id= fields.Many2one('product.product',string='Product')
