...
class AccountInvoice(models.Model):
    ...
    puerto_destino = fields.Many2one('stock.picking.type', string=u'Puerto Destino')
    #incoterm_id = fields.Many2one('stock.incoterms', string=u'Incoterm')

class AccountInvoiceLine(models.Model):
    _inherit = 'account.invoice.line'
    nandina = fields.Many2one('partida.arancelaria', related='product_id.partida', store=True, readonly=True, copy=False)
