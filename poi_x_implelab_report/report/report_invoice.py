...
class FacElecReport8D(models.AbstractModel):
    _name = 'report.account.account_invoice_report_duplicate_main'

    @api.multi
    def render_html(self, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('account.account_invoice_report_duplicate_main')
        docargs = {
            'doc_ids': self._ids,
        ...
        return report_obj.render('poi_x_implelab_report.copy_invoice', docargs)
