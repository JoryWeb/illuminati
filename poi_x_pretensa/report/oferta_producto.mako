...
<body>
    %for order in objects:
        ...
        <table width="100%">
            ...
            <tr>
                <td class="texto_leftb"><br />1.&nbsp;${order.product_type.punto_uno}</td>
            </tr>
            <tr>
                <td>
                        ...
                        <td width="60%">
                            <table cellspacing="0" width="80%">
                                ...
                                %for line in order.order_line:
                                    ...
                                    <tr>
                                        <td style="font-weight:bold; font-size:12px; text-align:center; font-family: Arial, arial, ARIAL, sans-serif; border-bottom: 1px solid black; border-left: 1px solid black; border-right: 1px solid black"
                                            width="20%">[${line.product_id.default_code}]${line.product_id.name}</td>
                                        <td style="font-weight:bold; font-size:12px; text-align:center; font-family: Arial, arial, ARIAL, sans-serif; border-bottom: 1px solid black; border-right: 1px solid black"
                                            width="20%">

                                            % if line.product_dimension.var_x:
                                                ${'{0:.2f}'.format(line.product_dimension.var_x or '')}${line.product_dimension.uom_id.name or ''}
                                            % endif
                                            % if line.product_dimension.var_y:
                                                x${'{0:.2f}'.format(line.product_dimension.var_y or '')}${line.product_dimension.uom_id.name or ''}
                                            % endif
                                            % if line.product_dimension.var_z:
                                                x${'{0:.2f}'.format(line.product_dimension.var_z or '')}${line.product_dimension.uom_id.name or ''}
                                            % endif
                                        </td>
                                        <td style="font-weight:bold; font-size:12px; text-align:center; font-family: Arial, arial, ARIAL, sans-serif; border-bottom: 1px solid black; border-right: 1px solid black"
                    ...
                    <tr>
                        <td><span class="texto_left">
                               ...
                               <ul>
                                    ...
                                    <li>
                                    ${order.product_type.impuestos_ley or ''}&nbsp;
                                        % if tipo_producto=='REJILLA DE JARDIN' or tipo_producto=='CORDON DE ACERA' or tipo_producto=='PLACA Y/O POSTE' :
                                            ${lugar_entrega or ''}
                                        % else:
                                            ${tipo_eps or ''}
                                        % endif
        ...
        <table>
            ...
            <tr>
                <td><span class="texto_left">${order.product_type.especificaciones | safe}</span></td>
            </tr>
            <tr>
                <td><span class="texto_leftb"><br>3.&nbsp;PLAZO DE ENTREGA:&nbsp;</span><br><span
                        style="font-size:12px;">${order.product_type.plazo_entrega | safe}</span></td>

            </tr>
            <tr>
                <td><span
                        class="texto_leftb"><br>4.&nbsp;COSTO OFERTADO:<br> <br>${currency} ${formatLang(order.amount_total)}
                    ...
                    <table border=0 width="100%">
                        <tr>
                            ...
                            <td align="center" width="40%"
                                style="text-align:center;font-size:10px; font-family: Arial, arial, ARIAL, sans-serif; border-top: 1px solid black;">
                                <span style="font-size:10px;">${user_name}&nbsp;-&nbsp;${mobile}</span>
                            </td>
                            <td width="30%">
                                &nbsp;
                            </td>
