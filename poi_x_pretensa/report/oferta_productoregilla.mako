       ...
       <table border=0 width="100%">
       		...
       		<td width="60%"> 
	   			<table cellspacing="0" width="80%">
	   				<tr>
	   					...
	   					<td style="font-weight:bold; font-size:12px; text-align:center; font-family: Arial, arial, ARIAL, sans-serif; border-top: 1px solid black; border-bottom: 1px solid black; border-right: 1px solid black; background-color: #D8D8D8" width="20%">DIMENSION</td>
        ...
        %for line in order.order_line:
            		...
            		<tr>
	   					...
	   					<td style="font-weight:bold; font-size:12px; text-align:center; font-family: Arial, arial, ARIAL, sans-serif; border-bottom: 1px solid black; border-right: 1px solid black" width="20%">
        			...
        			<tr>
            			<td><span class="texto_left">
                           ...
                           <ul>
                                ...
                                % if tipo_producto=='REJILLA DE JARDIN' or tipo_producto=='CORDON DE ACERA':
                                    ${lugar_entrega or ''}
                                % else:
                                    ${tipo_eps or ''}
                                % endif
                                ...
                                <li>Precios incluyen impuestos de Ley.</li><br>
                                <li>El material cotizado es puesto sobre camión en obra dentro del radio urbano, no contempla descarguío.</li><br>
                                <li>El costo del material deberá ser cancelado previo a su entrega.</li><br>
                                </li>
                            </ul>
                    </span></td>
        			</tr>
        ...
        <tr>
            <td><span class="texto_leftb"><br>3.&nbsp;PLAZO DE ENTREGA:&nbsp;</span><br><span style="font-size:12px;">${order.product_type.plazo_entrega}</span></td>
