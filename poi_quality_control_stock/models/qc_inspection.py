...
class QcInspection(models.Model):
    ...
    def get_picking(self):
        ...
        if self.object_id:
            if self.object_id._name == 'stock.move':
                ...
                self.picking = self.object_id.picking_id
            elif self.object_id._name == 'stock.pack.operation.lot':
                self.picking = self.object_id.operation_id.picking_id
    ...
    def get_lot(self):
        self.lot = False
        if self.object_id:
            if self.object_id._name == 'stock.pack.operation.lot':
    ...
    def _get_product(self):
        ...
        if self.object_id:
            if self.object_id._name == 'stock.move':
                ...
                self.product = self.object_id.operation_id.product_id
            elif self.object_id._name == 'stock.production.lot':
                self.product = self.object_id.product_id
    ...
    def _prepare_inspection_header(self, object_ref, trigger_line):
        ...
        if object_ref and object_ref._name == 'stock.pack.operation.lot':
            res['qty'] = object_ref.qty
